...
PEP_TARGET_POSITION = 15      # target long position (to harvest carry) [grid search optimized]
PEP_TARGET_WIDTH    = 5       # acceptable range around target: [10, 20] [grid search optimized]
